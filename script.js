...
function tellMe(joke){
     ...
     VoiceRSS.speech({
            key: 'ec9821d1fd8a4daeb5a44c99b409b441', 
            src: joke,
            hl: 'en-us',
            v: 'Linda',
            r: 0, 
...
async function getJokes(){
    ...
    try {
        ...
        if (data.setup){  /*if there's a setup*/
...
audioElement.addEventListener('ended',toggleButton); // when th audio has finished playing